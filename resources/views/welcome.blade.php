...
<div
    ...
    @if (Route::has('login'))
        <div class="fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
                <a href="{{ route('dashboard') }}" class="text-lg text-gray-700 ">Dashboard &nbsp;&nbsp;|</a>

                <a href="{{ url('/') }}" class="ml-4 text-lg text-gray-700 ">Blog &nbsp;&nbsp;|</a>

                <a href="{{ route('logout') }}" class="ml-4 text-lg text-gray-700 ">Logout</a>
            @else
                <a href="{{ url('/') }}" class="text-lg text-gray-700 ">Blog &nbsp;&nbsp;|</a>

                <a href="{{ route('login') }}" class="ml-4 text-lg text-gray-700 ">Log in &nbsp;&nbsp;|</a>
                    ...
                    <a href="/">
                        <svg width="180" height="90" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <g id="Layer_1">
                                ...
                                <text transform="matrix(1.68301 0 0 1.75 -51.8021 -61.875)" stroke="#000"
                                      font-style="normal"
                                      font-weight="normal" xml:space="preserve" text-anchor="start"
                                      font-family="'Harlow Solid Italic'"
                                      font-size="10" id="svg_3" y="82.92857" x="61.5836" fill-opacity="null"
                                      stroke-opacity="null"
                                      stroke-dasharray="null" stroke-width="0" fill="#000000">Solutions in Web</text>
                            </g>
                        </svg>
                    </a>
                </h1>
