...
<head>
    ...
    <meta name="author" content="Fahim Foysal">
    ...
    {{--  Custom styles for each pages  --}}
    @yield('page-level-stylesheets')
...
@section('sidebar')
    <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
               href="/" target="_blank">
                <div class="sidebar-brand-icon rotate-n-15">
                    <img src="{{Asset('blog/img/favicon.png')}}" alt="icon">
                </div>
                <div class="sidebar-brand-text mx-3">SolvVeb</div>
            </a>
            ...
            <!-- Nav Item - Posts -->
            <li class="nav-item {{ request()->routeIs('posts.*') || request()->routeIs('comments.*')  ? 'active':'' }}">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Solvveb Tech Blog {{date('Y')}}</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
